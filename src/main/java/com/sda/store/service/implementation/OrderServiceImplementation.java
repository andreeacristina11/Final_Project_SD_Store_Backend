...
public class OrderServiceImplementation implements OrderService {
    ...
    public OrderServiceImplementation(OrderRepository orderRepository, UserRepository userRepository, ProductRepository productRepository
    ...
    @Override
    public List<Order> fndAllOrdersByUserId (Long id) {
